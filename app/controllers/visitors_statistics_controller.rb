class VisitorsStatisticsController < ApplicationController
  ...
  def show
    ...
    @n_bcs_visitors = Visitor.where(:created_at => @start_date..@end_date).
    ...
    @n_sa_visitors = Visitor.where(:created_at => @start_date..@end_date).
    ...
    @n_h_visitors = Visitor.where(:created_at => @start_date..@end_date).
